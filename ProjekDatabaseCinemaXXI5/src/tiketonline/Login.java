...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        setTitle("Halaman Masuk Akun Pembeli"); 
    }
       ...
       String sql = "SELECT * FROM user WHERE username=? and password=?";
        try {
            ...
            if (rs.next()) {
                ...
                sesi.setUsername(txt_username.getText());

                // Menampilkan pesan sukses dengan username yang sedang login
                JOptionPane.showMessageDialog(null, "Login sebagai " + sesi.getUsername());

                // Menutup jendela login saat ini
                dispose();

                // Membuka jendela TiketBioskopFrame
                TiketBioskop tiketBioskopFrame = new TiketBioskop();
                tiketBioskopFrame.setVisible(true);
            } else {
