...
public class staff extends javax.swing.JFrame {
    ...
    public staff() {
        initComponents();
        setTitle("Halaman Masuk Akun Admin");
        this.dispose();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Masuk Staf Cinema XXI 5");
        ...
        jLabel2.setText("Silahkan Masuk Sebagai Staf :");

        jLabel3.setFont(new java.awt.Font("Lucida Fax", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Nama Pengguna :");

        username.setFont(new java.awt.Font("Lucida Fax", 1, 14)); // NOI18N
        ...
        lihatsandi.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
       String sql = "SELECT Id_Admin, Username FROM admin WHERE Username=? AND password=?";
        try {
            ...
            rs = pst.executeQuery();
            if (rs.next()) {
                // Menyimpan informasi login di sesi
                String adminId = rs.getString("Id_Admin");
                String adminUsername = rs.getString("Username");
                
                // Menampilkan pesan sukses dengan username yang sedang login
              //  sesiadm.setAdminId(adminId);
                admin adm = new admin();
                
                 adm.setAdminId(adminId);
                 adm.setAdminUsername(adminUsername);
                 JOptionPane.showMessageDialog(null, "Login sebagai " + adminUsername);
                adm.setVisible(true);
                ...
                // Membuka jendela TiketBioskopFrame
                                // Menutup jendela login saat ini

            } else {
                // Menampilkan pesan kesalahan untuk username atau password yang salah
