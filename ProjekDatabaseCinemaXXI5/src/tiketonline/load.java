...
public class load extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bar.setBackground(new java.awt.Color(0, 0, 153));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(bar, javax.swing.GroupLayout.PREFERRED_SIZE, 606, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[])  {
        ...
        try{
            ...
            {Thread.sleep(30);
            ld.bar.setValue(i);
            UIManager.put("nimbusOrange", new Color(0, 0, 153));
            }
        } catch (Exception e)
        {
